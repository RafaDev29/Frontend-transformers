...
<template>
  ...
  <section class="w-[800px] h-[600px] flex flex-col
    ...
    <div class="px-5 py-3 border-b border-slate-200 dark:border-slate-700
      ...
      <div class="absolute inset-0 opacity-5 dark:opacity-10">
        <div class="absolute top-0 left-0 w-24 h-24 bg-color1 rounded-full blur-3xl"></div>
        <div class="absolute top-0 right-0 w-16 h-16 bg-color3 rounded-full blur-2xl"></div>
      </div>

      <div class="relative flex items-center justify-between">
        <div class="flex items-center gap-3">
          <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-color1 to-color2 
        ...
        <span class="inline-flex items-center gap-1 text-xs font-semibold px-3 py-1 rounded-lg
    ...
    <!-- Body Compacto con 2 columnas -->
    <div class="flex-1 p-4 overflow-y-auto bg-white dark:bg-slate-800">
      <div class="grid grid-cols-2 gap-4 h-full">
        ...
        <div class="space-y-3">
          <div class="bg-gradient-to-br from-color5/30 to-color4/20 dark:from-colorDark2/30 dark:to-colorDark3/20 
                        rounded-xl p-3 border border-color3/20 dark:border-colorDark3/30">
            <h3 class="text-xs font-bold text-color1 dark:text-color4 mb-3 flex items-center gap-1">
            ...
            <div class="grid grid-cols-1 gap-1 text-xs">
              ...
              <div class="flex justify-between items-center py-1 border-b border-accent-warning/20 dark:border-amber-800/30">
        ...
        <div class="space-y-3">
          ...
          <div class="bg-gradient-to-br from-slate-50 to-neutral-light dark:from-slate-900/50 dark:to-colorDark1/50 
                        rounded-xl p-3 border border-slate-200 dark:border-slate-700">
            <h3 class="text-xs font-bold text-slate-800 dark:text-slate-200 mb-3 flex items-center gap-1">
              <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="grid grid-cols-1 gap-1 text-xs">
              <div class="flex justify-between items-center py-1 border-b border-slate-200 dark:border-slate-700/50">
          ...
          <div class="bg-gradient-to-br from-color5/50 to-color4/30 dark:from-colorDark3/30 dark:to-colorDark4/20 
                        rounded-xl p-3 border border-color3/30 dark:border-colorDark3/40">
            <h3 class="text-xs font-bold text-color1 dark:text-color4 mb-3 flex items-center gap-1">
              <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <!-- Cliente -->
          <div v-if="transformer?.customer" class="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 
                        rounded-xl p-3 border border-purple-200/50 dark:border-purple-800/30">
            <h3 class="text-xs font-bold text-petroleum dark:text-purple-300 mb-3 flex items-center gap-1">
              <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="space-y-2 text-xs">
              ...
              <div v-if="transformer?.saleDate" class="flex flex-col gap-0.5">
