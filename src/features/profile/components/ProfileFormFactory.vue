<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 to-color5 py-2 px-2">
              ...
              <div class="sticky top-8">
                ...
                <div class="text-center">
                  <div class="relative inline-block">
                    <div class="w-32 h-32 rounded-2xl bg-gradient-to-r from-color1 to-color2 flex items-center justify-center shadow-lg overflow-hidden">
                      <img 
                        v-if="photoPreview" 
                        :src="photoPreview" 
                        alt="Logo Preview" 
                    ...
                    <!-- Upload Button -->
                    <label class="absolute -bottom-3 -right-3 w-10 h-10 bg-accent-primary hover:bg-color1 text-white rounded-full flex items-center justify-center cursor-pointer transition-all duration-200 shadow-lg hover:shadow-xl">
            ...
            <div class="lg:col-span-2 space-y-6">
              ...
              <div class="border-t border-slate-200 pt-6">
                ...
                <div class="mb-6">
                  ...
                  <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <svg class="h-5 w-5 text-neutral-medium" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12,2C13.1,2 14,2.9 14,4C14,5.1 13.1,6 12,6C10.9,6 10,5.1 10,4C10,2.9 10.9,2 12,2M21,9V7L15,1H5C3.89,1 3,1.89 3,3V7H9V9H3V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V9H21Z"/>
                      </svg>
                    </div>
                    <input
              ...
              <div class="flex justify-end pt-4">
                <button
                  type="submit"
                  :disabled="loading"
                  class="bg-gradient-to-r from-color1 to-color2 text-white py-3 px-8 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none min-w-[160px]"
                >
