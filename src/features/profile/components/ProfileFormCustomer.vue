            ...
            <div class="lg:col-span-2 space-y-6">
              ...
              <div class="space-y-2">
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    placeholder="Ej: Minera Antamina S.A."
                    required
                  >
                </div>
              </div>
              ...
              <div class="flex flex-col sm:flex-row gap-4 pt-4">
                <button
                  type="button"
                  @click="resetForm"
                  class="flex-1 bg-slate-200 hover:bg-slate-300 text-slate-700 py-3 px-6 rounded-xl font-semibold transition-all duration-200"
                >
                  Limpiar Formulario
                </button>
                <button
