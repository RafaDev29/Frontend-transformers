            ...
            <div>
              <div class="flex items-center gap-3 mb-2">
                ...
                <h2 class="text-2xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 dark:from-slate-200 dark:to-slate-400 bg-clip-text text-transparent">
                 Monitoreo de Distorsión Armónica (THDI)
                </h2>
              </div>
              <p class="text-slate-600 dark:text-slate-400 font-medium">
                      Monitoreo de Distorsión Armónica de corriente, valores min. y max.
              </p>
            </div>
          ...
          if (ch1Val != null) {
            html += `
              <div style="display: flex; align-items: center; gap: 8px;">
                ...
                <span style="font-weight: 600; color: #1e7f14;">${ch1Val.toFixed(2)}%</span>
              </div>
            `
          }
          ...
          if (ch2Val != null) {
            html += `
              <div style="display: flex; align-items: center; gap: 8px;">
                ...
                <span style="font-weight: 600; color: #dc2626;">${ch2Val.toFixed(2)}%</span>
              </div>
            `
          }
          ...
          if (ch3Val != null) {
            html += `
              <div style="display: flex; align-items: center; gap: 8px;">
                ...
                <span style="font-weight: 600; color: #0891b2;">${ch3Val.toFixed(2)}%</span>
              </div>
            `
          }
        ...
        hooks: {
          draw: [
            (u) => {
              ...
              ctx.fillText(`Mínimo: ${min.toFixed(1)}%`, u.bbox.left + u.bbox.width - 10, minY + 5)
              
              // Etiqueta máxima
              ctx.fillStyle = '#10b981'
              ctx.fillRect(u.bbox.left + u.bbox.width - 120, maxY - 14, 110, 26)
              ctx.fillStyle = '#ffffff'
              ctx.fillText(`Máximo: ${max.toFixed(1)}%`, u.bbox.left + u.bbox.width - 10, maxY + 5)
              ctx.restore()
            }
          ]
        }
