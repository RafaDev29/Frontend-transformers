          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 items-center">
            <div>
              <div class="flex items-center gap-3 mb-2">
                ...
                <h2
                  class="text-xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 dark:from-slate-200 dark:to-slate-400 bg-clip-text text-transparent">
                  Monitoreo de Distorsión Armónica de Corriente
                </h2>
              </div>
          ...
          if (ch1Val != null) {
            html += `
              <div style="display: flex; align-items: center; gap: 8px;">
                ...
                <span style="font-weight: 600; color: #16a34a;">${ch1Val.toFixed(2)}%</span>
              </div>
            `
          }
          ...
          if (ch2Val != null) {
            html += `
              <div style="display: flex; align-items: center; gap: 8px;">
                ...
                <span style="font-weight: 600; color: #ef4444;">${ch2Val.toFixed(2)}%</span>
              </div>
            `
          }
