<template>
  <div
    class="p-3 rounded-2xl shadow-md flex items-center gap-3 w-full overflow-x-auto
  ...
  >
    ...
    <div class="flex gap-2">
      <button
        ...
        class="px-3 py-2 text-sm font-medium rounded-lg shadow-sm transition-colors duration-200 whitespace-nowrap"
        :class="[
          isActive(btn.value)
