<template>
  ...
  <div class="overflow-x-auto md:overflow-x-visible">
    <!-- Grid -->
    <div 
      class="grid grid-cols-3 md:grid-cols-3 gap-1 md:gap-1 min-w-[300px] md:min-w-0"
    >
      <div 
      ...
      >
        ...
        >
          ...
          <div class="text-right">
            ...
            <p class="text-[10px] md:text-xs" :class="phase.sub">Tensión actual de {{ phase.label }}</p>
          </div>
        </div>
      </div>
    </div>
