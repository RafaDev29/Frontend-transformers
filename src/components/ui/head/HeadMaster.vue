    ...
    <div class="relative flex items-center justify-between p-3 lg:px-6">
      ...
      <div class="flex-shrink-0 ml-4">
        <div class="relative group">
          ...
          <div class="absolute -inset-1.5 bg-gradient-to-r from-color3/50 to-color4/50 rounded-xl blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          ...
          <!-- Indicador de estado -->
          <div class="absolute -bottom-1 -right-1 w-5 h-5 bg-accent-success rounded-full border-2 border-white shadow-md flex items-center justify-center">
