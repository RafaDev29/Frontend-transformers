<template>
  ...
  <div
    ...
    <div v-if="!rail" class="relative bg-gradient-to-r from-slate-50/80 via-white/60 to-slate-50/80 dark:from-slate-800/60 dark:via-slate-700/40 dark:to-slate-800/60 backdrop-blur-md border-b border-slate-200/60 dark:border-slate-600/40 p-3 rounded-t-2xl">
      ...
      <div v-show="open" class="px-3 pb-3 space-y-1 animate-fade-in" :class="{ 'rail-menu': rail }">
        ...
        <template v-if="rail">
          ...
          <div class="flex items-center justify-center py-2">
            <div class="w-8 h-px bg-gradient-to-r from-transparent via-slate-300 dark:via-gray-600 to-transparent"></div>
          </div>
