    ...
    <div class="p-3 flex-1 overflow-y-auto">
      ...
      <div v-if="maintenanceItems.length > 0" class="mt-4 relative">
              ...
              <v-tooltip :disabled="!rail" :text="item.title" location="end">
                <template #activator="{ props: tooltipProps }">
                  <router-link v-bind="rail ? tooltipProps : {}" :to="item.to"
                    ...
                    <div v-if="$route.path === item.to"
                      class="absolute left-0 top-1 bottom-3 w-1 bg-gradient-to-b from-emerald-500 to-green-600 dark:from-emerald-400 dark:to-green-500 rounded-r shadow-sm" />
                    ...
                    <div
                      ...
                      :class="$route.path === item.to
                        ...
                        ">
                      <svg viewBox="0 0 24 24" class="h-5 w-5 transition-transform duration-300 group-hover:rotate-12">
                        <path :d="$icons[item.icon]" fill="currentColor" />
                      </svg>
                    </div>
        ...
        <div @click="toggleMaintenance"
          ...
          <div
            class="px-4 py-2 bg-gradient-to-r from-emerald-100/80 to-green-100/60 dark:from-emerald-800/40 dark:to-green-800/30 transition-all duration-300 hover:from-emerald-200/80 hover:to-green-200/60 dark:hover:from-emerald-700/50 dark:hover:to-green-700/40 rounded-2xl">
